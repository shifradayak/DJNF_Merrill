...
<img src="intro_images/DJNF_Logo.png" width="300" height="150"/>
<img src="intro_images/merrill-logo-dark.png" width="300" height="50"/>
:::
...
::: {style="text-align: center;"}
<img src="intro_images/bubble.png" width="700" height="600"/>
:::
...
**1) Which Day Had the Most 311 Calls?**
...
**See what happens without group_by**
Only the top value is computed, not the aggregation of the component parts
```{r}
...
<img src="intro_images/group_by.png" width="400" height="400" />
<br>   
<br> 
...
Pro tip: [slice_max to the rescue](https://dplyr.tidyverse.org/reference/slice.html)
...
What are the top five complaints in this data and provide the number of complaints
...
[Background on dealing with dates](https://github.com/profrobwells/Data-Analysis-Class-Jour-405v-5003/blob/master/Readings/dealing-with-dates.pdf)
...
**Ready for More?**
Check out [Gathering and Cleaning Data, which describes APIs](https://wellsdata.github.io/DJNF_Merrill/Intro_to_R_2024/DJNF_Gathering_Cleaning_Data.html)
