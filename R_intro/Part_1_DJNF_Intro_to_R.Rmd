...
#Executive Editor -- news, no gender specified, Black
...
#Which one is higher?
#The average for Bloomberg is higher
...
```{r}
Editors <- subset(MediaBucks, grepl("?editor | Editor", TITLE))
...
```
```{r}
Data <- subset(MediaBucks, grepl("?data | Data", TITLE))
```
