...
-   Map of where the most spills have occurred in Connecticut (numbers-wise and per 1,000 residents)

-   Chart of top dischargers

-   Map of biggest spills overlaid on income levels or non-white population percentage in different towns

-   Scatterplot showing the relationship between a demographic measure of some kind and number of spills
...
1.  **What have spill numbers looked like between 1996 and 2022?**
...
I'm curious what the biggest types of spills recorded in this dataset have been, and how they may have changed over the years.

2.  **What are the trends in top substances spilled over the years?**
...
3.  **What could have contributed to the peak of reported spills in 2001?**
...
4.  **How have spills varied (both in raw numbers and normalized for population) across different towns in Connecticut?**
...
Often, with environmental spills, there's a small subset of companies that's at fault for repeated incidents.
Let's see if that's the case here.

5.  **What are the trends of actors responsible for these spills?**
...
Finally, let's look at spills from an environmental justice perspective.

6.  **How are demographic factors (race, socioeconomic status) related to spills?**
